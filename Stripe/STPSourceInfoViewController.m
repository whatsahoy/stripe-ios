...
- (instancetype)initWithSourceParams:(STPSourceParams *)sourceParams
    ...
    STPSourceType sourceType = [STPSource typeFromString:sourceParams.type];
    if (![[self class] canCollectInfoForSourceType:sourceType]) {
        return nil;
    }
    if (self) {
        _sourceParams = sourceParams;
        _sourceType = sourceType;
        self.title = [self titleForSourceType:sourceType];
    }
    return self;
}
